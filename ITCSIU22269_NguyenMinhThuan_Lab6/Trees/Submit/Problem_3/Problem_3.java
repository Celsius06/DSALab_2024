// Add a method that determines whether a binary tree is fully balanced. This method takes
// no parameters and returns a Boolean value: true if the tree is fully balanced and false if not.

package Trees.Submit.Problem_3;
...
public class Problem_3 {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            System.out.print(
                    "insert, find, delete, traverse, quit, or check if the tree is balanced (b) ");
            System.out.print("(s/i/f/d/t/q/b): ");
            int choice = getChar();
            switch (choice) {
                case 's':
...
class Tree {
    ...
    // Methods to determine if the binary tree is fully balanced
    public int height() {
        return height(root);
    }
