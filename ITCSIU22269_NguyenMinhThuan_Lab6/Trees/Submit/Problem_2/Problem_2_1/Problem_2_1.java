// Add a method that computes the height of a binary tree into the Tree Class. Specifically,
// this method has no parameters and returns an integer equal to the height of the tree.

package Trees.Submit.Problem_2.Problem_2_1;
...
public class Problem_2_1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            System.out.print(
                    "insert, find, delete, traverse, quit, or height of the tree (h) ");
            System.out.print("(s/i/f/d/t/q/h): ");
            int choice = getChar();
            switch (choice) {
                case 's':
...
class Tree {
    ...
    // Methods to compute the height of the binary tree
    public int height() {
        return height(root);
    }
