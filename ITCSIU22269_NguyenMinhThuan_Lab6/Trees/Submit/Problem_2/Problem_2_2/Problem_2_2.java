// Add a method that counts a binary tree’s leaves tree into the Tree Class. Specifically, this
// method has no parameters and returns an integer equal to the number of leaves in the tree.

package Trees.Submit.Problem_2.Problem_2_2;
...
public class Problem_2_2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            System.out.print(
                    "insert, find, delete, traverse, quit, or count the leaves (l) ");
            System.out.print("(s/i/f/d/t/q/l): ");
            int choice = getChar();
            switch (choice) {
                case 's':
                ...
                case 'q':
                    return;
                case 'l':
                    int leafCount = theTree.countLeaves();
...
class Tree {
    ...
    // Methods to count the number of leaves in the binary tree
