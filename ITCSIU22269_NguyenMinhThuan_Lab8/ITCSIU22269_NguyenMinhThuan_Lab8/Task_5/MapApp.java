...
public class MapApp {
    ...
    public static void main(String[] args) {
        ...
        List<Character> shortestPathAH = graph.shortestPath(0, 7); // 0: A, 7: H

        System.out.print("[Dijkstra] Shortest path from A to H: ");
        for (char vertex : shortestPathAH) {
            System.out.print(vertex + " ");
        }

        // Find the shortest path from B to J
        List<Character> shortestPathBJ = graph.shortestPath(1, 9); // 1: B, 9: J

        System.out.print("\n[Dijkstra] Shortest path from B to J: ");
        for (char vertex : shortestPathBJ) {
            System.out.print(vertex + " ");
        }
    }
}