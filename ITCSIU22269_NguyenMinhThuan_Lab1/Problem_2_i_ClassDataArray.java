public class Problem_2_i_ClassDataArray {
    ...
    static class ClassDataArray {
        ...
        public boolean delete(String searchName) { // delete person from array
            ...
            if (j == nElems) { // can't find it
                ...
                for (int k = j; k < nElems - 1; k++) { // shift down (fix: -1 for correct shifting)
                    a[k] = a[k + 1];
                }
...
} // end Problem_2_i_ClassDataArray
