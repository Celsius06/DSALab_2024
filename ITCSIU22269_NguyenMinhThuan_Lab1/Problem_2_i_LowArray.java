public class Problem_2_i_LowArray {
    ...
    static class LowArrayApp {
      public static void main(String[] args) {
        ...
        for (j = 0; j < nElems; j++) { // display items
          System.out.print(arr.getElem(j) + " "); // Corrected concatenation
        }
        System.out.println();
        ...
        if (j == nElems) { // no
          System.out.println("Can't find " + searchKey); // Corrected space before quote
        } else { // yes
        ...
        for (int k = j; k < nElems - 1; k++) { // move higher ones down (fix missing closing parenthesis)
  ...
  } // end class Problem_2_i_LowArray
